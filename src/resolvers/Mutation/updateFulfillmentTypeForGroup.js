...
/**
 * @name Mutation/updateFulfillmentTypeForGroup
 * @method
 ...
 */
export default async function updateFulfillmentTypeForGroup(parentResult, { input }, context) {
    const { cartId: opaqueCartId, cartToken, clientMutationId = null, fulfillmentGroupId: opaqueFulfillmentGroupId, fulfillmentType } = input;
    ...
    const { cart } = await context.mutations.updateFulfillmentTypeForGroup(context, {
        cartId,
        cartToken,
        fulfillmentGroupId,
        fulfillmentType
